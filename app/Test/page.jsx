    ...
    <div className="max-w-2xl mx-auto text px-2">
      ...
      <div className="flex flex-col gap-5 mt-5">
        {new Array(10).fill(0).map((_, i) => (
          ...
          >
            <img
              src="https://preview.redd.it/whats-a-popular-jav-genre-or-tag-that-everyone-seems-to-v0-k9kqiz101pxd1.jpg?width=533&format=pjpg&auto=webp&s=94c06b453d2bb8a353b3eb663c6bac80d6fde754"
              alt=""
