...
function Themeswitchbutton() {
  ...
  return (
    <label className="inline-flex items-center relative cursor-pointer">
      ...
      after:absolute after:content-[''] after:w-[20px] after:h-[20px] 
      after:bg-gradient-to-r from-orange-500 to-yellow-400 
      peer-checked:after:from-zinc-900 peer-checked:after:to-zinc-900 
      after:rounded-full after:top-1/2 after:-translate-y-1/2 after:left-[5px] 
      active:after:w-[25px] peer-checked:after:left-[55px] peer-checked:after:translate-x-[-100%] 
      ...
      <svg
        viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg"
        className="fill-black opacity-60 peer-checked:opacity-70 peer-checked:fill-white absolute w-4 h-4 right-[6px]"
      >
